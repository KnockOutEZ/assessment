<template>
  <div class="wrapper antialiased text-gray-900 my-10 hover:shadow-xl">
<div>
    
    <img src="https://source.unsplash.com/random/350x350" alt=" random imgee" class="z-1 w-2/4 mx-auto object-cover object-center rounded-full shadow-md">    
